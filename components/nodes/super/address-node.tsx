      ...
      >
        ...
        <CardContent className="pt-0 space-y-3 pb-3 px-4">
          ...
          {isEditingQuestion ? (
            ...
            <div
              className="text-sm text-muted-foreground line-clamp-4 cursor-pointer hover:bg-blue-50/30 dark:hover:bg-blue-950/20 px-2 py-1.5 rounded border border-transparent hover:border-blue-100 dark:hover:border-blue-800 transition-colors whitespace-pre-wrap"
