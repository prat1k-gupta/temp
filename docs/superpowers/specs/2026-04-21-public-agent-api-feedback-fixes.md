...
| PR-3 `description` end-to-end | already wired on main (no PR needed) | [magic-flow#103](https://github.com/freestandtech/magic-flow/pull/103) merged | covered in #103 | ✅ shipped + prod-verified |
