...
|---|---|---|---|---|
| PR-1 Audience fields + preview echo | implemented locally (fs-whatsapp branch `agent-api/audience-fields`) | — | appended to `integration-rest.md` in main checkout | code ready, not yet committed / PR'd |
| PR-2 Server-side flow search | — | — | — | queued |
| PR-4 Flow variable buckets | — | — | — | in progress (worktree) |
