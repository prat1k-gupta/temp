...
export function WhatsAppQuickReplyNode({ data, selected }: { data: any; selected?: boolean }) {
  ...
  return (
    <div className="relative">
      ...
      <Card
        className={`min-w-[280px] max-w-[320px] bg-card border-green-200 shadow-lg transition-all duration-200 hover:shadow-xl hover:border-green-400 ${
      ...
      >
        <CardHeader className="pb-2 bg-green-50">
          <div className="flex items-center gap-2">
            ...
            {isEditingLabel ? (
              ...
              >
                {data.label || "WhatsApp Quick Reply"}
        ...
        <CardContent className="pt-0 space-y-3 pb-12">
          {isEditingQuestion ? (
            ...
            <div
              className="text-sm text-muted-foreground p-2 bg-green-50 rounded border border-green-200 cursor-pointer hover:bg-green-100 hover:border-green-300 transition-colors"
              ...
              <div key={index} className="relative group">
                {editingButtonIndex === index ? (
                  <div className="space-y-2">
                    <div className="flex items-center gap-1">
                      <Input
                        ...
                        className={`h-8 text-xs bg-white border-green-300 focus:border-green-500 ${
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      >
                        {editingButtonValue.length}/{WHATSAPP_LIMITS.button} characters
                      </span>
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="w-full justify-start text-xs h-8 bg-green-100 border-green-200 hover:bg-green-150 hover:border-green-300 text-green-800 transition-colors cursor-pointer"
